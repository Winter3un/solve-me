 ...
 */
	...
	# common header
	$title = __SITE__['title'].' » Challeng Manage';
	$need_login = true;
	$js_files = [
		'/assets/js/chall.js'
	];
...
<button class="auth-btn btn btn-dark btn-xs pull-right" onclick='location="/chall/edit/<?php echo secure_escape($prob_info[$i]['no']);?>"'>Edit</button>
								</span>
...
<button type="submit" class="btn btn-primary mr-5" onclick="location='/chall/upload'">Upload</button>
